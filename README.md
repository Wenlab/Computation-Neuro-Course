...
## Nomination Rules
- Chinese can be used everywhere but not names (filenames, foldernames, projectnames, etc.)
- No space in the names, use hyphen "-" instead
- Potential directory issues (please enable custom input/output path in your program.)

# Build up personal website

Personal websites which built with GitHub Pages:
- [RYAN FITZGERALD Software Engineer](https://ryanfitzgerald.github.io/devportfolio/)
- [Academic Template Website](https://academicpages.github.io/)
- [Lantao Yu](http://lantaoyu.com/)
- [A simple demo site](http://hankquinlan.github.io/)

And it is totally free!

Want to build up your website? 
1. Fork a website you like to your repositories.
2. Update the content to your info.
3. Finished.

Tutorial to build up your website: [English](http://jmcglone.com/guides/github-pages/) [中文](https://www.jianshu.com/p/d344d51bcc4e)
...
# Mobile solution
I recommend using mobile apps to deal with issues and pull quests in an efficient way. Personally I highly recommend [Trello](https://trello.com) which can seamlessly integrate with GitHub by using [Unito Service](https://unito.io/sync/github/trello/). In this way, members within the same project can know the progress the project and interact in an efficient way.
